...
export const action = async ({ request } : ActionFunctionArgs) => {
	...
	const { data: booking, error: fetchErr } = await supabase
		.from("bookings")
		.select(`id, checkout_session_id, total, booking_ref, tour_id, tour_name, tour_option_name, customer_email, tour_details:tours!inner(cover_image), booking_status, payment_status`)
	...
	if(booking.booking_status === "CONFIRMED" || booking.booking_status === "CANCELLED" || booking.payment_status === "PAID" || booking.payment_status === "REFUNDED") {
